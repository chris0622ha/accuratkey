...
const TOPICS: Record<string, Topic> = {
  ...
  'getting-started': {
    ...
    faqs: [
      ['Do I need an account?', 'No. Guest mode gives full access to all 165 levels and all 37 games. Progress saves in your browser. Sign up to sync across devices, use friends and daily challenge features.'],
  ...
  'levels': {
    ...
    intro: 'AccuratKey has 165 levels of increasing difficulty, each targeting a specific typing skill.',
    sections: [
      { heading: 'The Level Map', body: 'The Level Map shows all 165 levels as connected nodes. Completed levels show ✓ in their color. Your current level glows with a pulse ring. Locked levels show 🔒. Tap a level to start or replay it.' },
  ...
  'accessibility': {
    ...
    sections: [
      ...
      { heading: '13+ years old', body: 'Full dark theme. JetBrains Mono font at standard size. Full word pool. All 165 levels. All features available (subject to Feature Access settings).' },
