...
const TOPICS: Record<string, Topic> = {
  ...
  'getting-started': {
    ...
    faqs: [
      ['Do I need an account?', 'No. Guest mode gives full access to all 170 levels and all 38 games. Progress saves in your browser. Sign up to sync across devices, use friends and daily challenge features.'],
